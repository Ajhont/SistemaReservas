				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<p>
								<strong>Área Médica: </strong>Medicina General Adulto
							</p>
							<p>
								<strong>Ubicación: </strong>Temuco
							</p>
							<p>
								<strong>Rut Paciente: </strong>11-153-153-8
							</p>
								...
								<div class="media">
									...
									<div class="col-sm-7">
										<h4 class="media-heading">
											Dr.
											<%= listaMedicos.getString("nombreMedico") %></h4>
										<p><%= listaMedicos.getString("nombreEspecialidad")%>
											-
											<%= listaMedicos.getString("nombreArea") %></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						<p class="text-danger">
							<strong>No existen resultados de la búsqueda.</strong>
						</p>
					</div>
				</div>
			</div>
