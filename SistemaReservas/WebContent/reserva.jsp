	...
	<section id="contact-us">
		<div class="container">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-3">
							<img class="img-circle" src="img/silueta.jpg"
								alt="Sider Big Image">
						</div>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<%
						ResultSet detallePaciente = (ResultSet) request.getAttribute("detallePaciente");
						if (detallePaciente.next()) {
					%>
					<form method="get" action="./reservaUpdateController">
						<input type="hidden" name="rutMedico"
							value="<%=detalleMedico.getString("rutMedico")%>"> <input
							type="hidden" name="idHora"
							value="<%=detalleHora.getString("idHoras")%>"> <input
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input class="form-control" type="text" name="rutPaciente"
									value="<%=detallePaciente.getString("rutPaciente")%>">
							</div>
							<div class="col-sm-4">
								<p>
								...
								<input class="form-control" type="text" name="aPaterno"
									value="<%=detallePaciente.getString("aPaternoPaciente")%>">
							</div>
							<div class="col-sm-4">
								<p>
									<b>Telefono:</b>
								...
								<input class="form-control" type="text" name="telefono"
									value="<%=detallePaciente.getString("telefono")%>">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input class="form-control" type="text" name="nombrePaciente"
									value="<%=detallePaciente.getString("nombrePaciente")%>">
							</div>
							<div class="col-sm-4">
								<p>
								...
								<input class="form-control" type="text" name="aMaterno"
									value="<%=detallePaciente.getString("aMaternoPaciente")%>">
							...
							<div class="col-sm-4">
								...
								<input class="form-control" type="email" name="email"
									value="<%=detallePaciente.getString("email")%>">

							</div>
						</div>
						<div class="row">
							<div class="col-lg-offset-5">
								<button type="submit" name="updatePaciente"
					...
					<form method="get" action="./reservaController">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<input class="form-control" type="text" name="aPaterno" value="">
							</div>
							<div class="col-sm-4">
								<p>
									<b>Telefono:</b>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<input class="form-control" type="text" name="aMaterno" value="">
						...
						<div class="row">
							<div class="col-lg-offset-5">
								<button type="submit" name="crearPaciente"
									class="btn btn-primary ">Reservar</button>
							</div>
						</div>
					</form>
