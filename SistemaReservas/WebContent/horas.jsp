							...
							<div class="media">
								<div class="col-sm-3">
									<img class="img-circle"
										src="https://thumbs.dreamstime.com/b/el-doctor-mantiene-la-taza-c%C3%ADrculo-35807758.jpg"
										alt="Dr. Enrique Salas">
								</div>
								<div class="col-sm-7">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="copy-text">
						<p>
							All Rights Reserved | Copyright 2017 © <strong>Víctor
								Huircaleo</strong> template by <strong><a
