...
<body>
	...
	<div class="container ">
		...
		<div class="panel panel-primary">
			<div class="panel-heading ">Hora reservada con:</div>
			...
			<br/>
			 ...
			 <p> <strong>XXXX</strong></p>
			  ...
			  <div class="col-lg-12 margintop10 field">
									...
									<div class="col-lg-4">
									<br/>
										<button type="submit" class="btn btn-danger btn-block">Anular Hora</button>
										
									</div>
									<div class="col-lg-4">
									<br/>
									<button type="submit" class="btn btn-block">Reservar con otro medico</button>
									</div>
