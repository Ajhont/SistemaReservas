									...
									<table class="table">
									    ...
									    <% ResultSet listaHoras = (ResultSet)request.getAttribute("listaHoras");
											...
											if(listaHoras.next()){
									      	...
									      	<tr>
									      		<th id="idHoras" class="hidden"><%= listaHoras.getString("idHoras") %></th>
										        <td class="success"><%= listaHoras.getString("horaHoras") %></td>
										        <td class="success">Disponible</td>
										        <td class="success"><button type="button" class="btn btn-primary btn-xs">Reservar</button></td>
									      	</tr>
									    <% 			}else { %>
									    	<tr>
										        ...
										        <td class="danger"><button type="button" disabled class="btn btn-primary btn-xs">Reservar</button></td>
									      	</tr>
								     	<% 			}
												}
										  	}else { %>
									      	<tr>
										        <td class="danger" colspan="4">No existen hora para la fecha seleccionada</td>										       
									      	</tr>
									    <% } %>									      					      
									    </tbody>
									</table>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('.datePicker').datepicker({
					...
					location.href= "./resultadoController?fecha="+fecha+"&rutMedico="+rutMedico+
