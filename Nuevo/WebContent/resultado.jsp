				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="panel panel-primary">
							<div class="panel-heading">Búsqueda General</div>
							<div class="panel-body">
								<p><strong>Área Médica: </strong><%= request.getAttribute("especialidad") %> / <%= request.getAttribute("area") %></p>
								<p><strong>Ubicación: </strong><%= request.getAttribute("ciudad") %></p>
								<p><strong>Rut Paciente: </strong><%= request.getAttribute("rutPaciente") %></p>
			  	...
			  	%>
				    <form method="POST" action="./resultadoController" >
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<div class="panel">
									<div class="panel-body">
			  	...
			  	<div class="container">
					<div class="row">						
						<div class="col-md-4 col-md-offset-4">							
							<p class="text-danger"><strong>No existen resultados de la busqueda</strong></p>								
						</div>
					</div>
				</div>
